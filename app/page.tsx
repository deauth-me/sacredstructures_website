...
const architectureData = [
  ...
  },
  {
    ...
    imageUrl: "/images/paro-taktsang.jpg",
    period: "Medieval (established), 17th century (current buildings)",
    description: "A prominent Himalayan Buddhist sacred site and monastery complex, dramatically perched on a cliffside in the upper Paro Valley. It is a key cultural icon of Bhutan.",
    yearBuilt: "1692 (current buildings)",
    architecturalStyle: "Bhutanese",
    features: ["Cliffside location", "Sacred caves", "Buddhist frescoes"]
  },
  {
  ...
  },
  {
    ...
    period: "Medieval (founded), current buildings 19th century",
    description: "The largest and most famous Eastern Orthodox monastery in Bulgaria. Nestled in the Rila Mountains, its current complex dates from the 19th century after a fire, showcasing vibrant frescoes and a unique architectural style.",
    yearBuilt: "10th century (founded), rebuilt 1815-1862",
    architecturalStyle: "Bulgarian Renaissance",
    features: ["Colorful frescoes", "Mountain setting", "Fortress-like complex", "Hreljo Tower"]
  }
];
