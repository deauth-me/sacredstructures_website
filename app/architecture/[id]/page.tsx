...
function getAdditionalImages(architecture: any) {
  ...
  const commonViews = ["interior", "altar", "dome", "facade", "detail", "plan"]
...
const architectureData = [
  ...
  {
  id: "votivkirche-vienna",
  name: "Votivkirche",
  type: "Church",
  location: "Vienna, Austria",
  imageUrl: "/images/votivkirche-vienna.jpg",
  period: "Neo-Gothic",
  description: "Built to commemorate the survival of Emperor Franz Joseph I after an assassination attempt, this Neo-Gothic masterpiece reflects French Gothic influence and serves as a symbol of the Habsburg era.",
  yearBuilt: "1856–1879",
  architecturalStyle: "Neo-Gothic",
  features: ["Twin spires", "Rose window", "Ribbed vaults", "Historical symbolism"],
},
{
  id: "st-stephens-cathedral-vienna",
  name: "St. Stephen’s Cathedral (Stephansdom)",
  type: "Cathedral",
  location: "Vienna, Austria",
  imageUrl: "/images/st-stephens-cathedral-vienna.jpg",
  period: "Gothic",
  description: "Vienna's most iconic religious structure, this Gothic cathedral features a richly tiled roof and towering south spire. It evolved over centuries, reflecting Romanesque and Gothic transitions.",
  yearBuilt: "Initial construction 1137; major Gothic phase 1359–1511",
  architecturalStyle: "Gothic with Romanesque elements",
  features: ["South Tower (Steffl)", "Colorful tiled roof", "Catacombs", "Giant Pummerin bell"],
},
{
  id: "church-holy-sepulchre",
  name: "Church of the Holy Sepulchre",
  type: "Church / Pilgrimage Site",
  location: "Jerusalem, Israel",
  imageUrl: "/images/church-holy-sepulchre.jpg",
  period: "Early Christian / Romanesque / Crusader",
  description: "Built over the believed sites of Jesus’ crucifixion and resurrection, this is Christianity’s holiest shrine. The current structure is mainly Crusader-era with Byzantine roots.",
  yearBuilt: "Originally 4th century, major reconstruction in 12th century (Crusader)",
  architecturalStyle: "Early Christian, Romanesque, Crusader",
  features: ["Golgotha", "Aedicule", "Rotunda", "Stone of Anointing"],
},
{
  id: "dormition-abbey",
  ...
  type: "Abbey",
  location: "Jerusalem, Israel",
  imageUrl: "/images/dormition-abbey.jpg",
  period: "Modern Romanesque Revival",
  description: "A Benedictine abbey built on Mount Zion, traditionally believed to be where the Virgin Mary 'fell asleep.' Its style revives Romanesque traditions in early 20th-century form.",
  yearBuilt: "1900–1910",
  architecturalStyle: "Romanesque Revival",
  features: ["Mount Zion location", "Circular nave", "Mosaics of Mary", "Crypt"],
},
{
  id: "st-anne-church-jerusalem",
  name: "Church of Saint Anne",
  type: "Church",
  location: "Jerusalem, Israel",
  imageUrl: "/images/st-anne-church-jerusalem.jpg",
  period: "Crusader (Romanesque)",
  description: "A perfectly preserved Crusader church near the Pool of Bethesda, known for its excellent acoustics and its simple yet powerful Romanesque design.",
  yearBuilt: "c. 1131–1138",
  architecturalStyle: "Crusader Romanesque",
  features: ["Acoustics", "Crusader masonry", "Plain facade", "Near Pool of Bethesda"],
},
  {
  id: "st-francis-church-vienna",
  name: "St. Francis of Assisi Church (Kaiser Jubilee Church)",
  type: "Church",
  location: "Vienna, Austria",
  imageUrl: "/images/st-francis-church-vienna.jpg",
  period: "Neo-Romanesque / Historicist",
  description: "Built to mark Emperor Franz Joseph’s 50th jubilee, this monumental church blends Neo-Romanesque and Neo-Gothic styles with a distinctive red-tiled roof and towers.",
  yearBuilt: "1898–1910",
  architecturalStyle: "Neo-Romanesque / Neo-Gothic",
  features: ["Triple-apse design", "Tiled conical towers", "Jubilee commemoration", "Danube riverside"],
},
{
  id: "zion-church-jerusalem",
  name: "Church of St. Peter in Gallicantu",
  type: "Church",
  location: "Jerusalem, Israel",
  imageUrl: "/images/st-peter-gallicantu.jpg",
  period: "Modern (Byzantine Revival)",
  description: "Built on the slopes of Mount Zion, this church marks the site where Peter denied Jesus three times. It includes archaeological remains of ancient dwellings and steps.",
  yearBuilt: "1931",
  architecturalStyle: "Byzantine Revival",
  features: ["Rooster symbol", "Underground prison", "Ancient stairs", "Mosaics and domes"],
},
{
  id: "pater-noster-church",
  name: "Church of the Pater Noster",
  type: "Church / Monastery",
  location: "Jerusalem, Israel",
  imageUrl: "/images/pater-noster-church.jpg",
  period: "Byzantine / 19th-century reconstruction",
  description: "Located on the Mount of Olives, this site commemorates Christ teaching the Lord’s Prayer. Features tiled plaques of the prayer in over 100 languages.",
  yearBuilt: "Original Byzantine church 4th century; reconstructed 1870s",
  architecturalStyle: "Byzantine with 19th-century French influence",
...
},
{
  ...
  type: "Church",
  location: "Vienna, Austria",
  imageUrl: "/images/dominican-church-vienna.jpg",
  period: "Baroque",
  description: "An ornate Baroque church located in the city center of Vienna, featuring a richly frescoed dome and side chapels influenced by the Roman Baroque.",
  yearBuilt: "1631–1674",
  architecturalStyle: "Baroque",
  features: ["Baroque dome", "Stucco and frescoes", "Latin cross plan", "Dominican order"],
},
  {
